module org::crossminer::util::CrossminerUtil
 ...
 */
public loc ANALYSIS_FILES_PATH = |project://CrossminerAnalyzer/data/analysis|;

/*
 * Path of the program binary files.
 */
public loc BINARY_FILES_PATH = |project://CrossminerAnalyzer/data|;

/*
 * Path of the bundle-bundle logical locations relation based on the import package header.
 */
public loc CROSSMINER_MODEL_PATH = BINARY_FILES_PATH + "crossminer-model";

public loc M3_PATH = BINARY_FILES_PATH + "m3";

public loc M3_TEST_PATH = |project://CrossminerAnalyzer/tests/data/m3|;
