module org::crossminer::analysis::smells::BestPractices
 ...
 * header in the Crossminer model.
 */
public real getRatioRequireBundleHeaderFreq(CrossminerModel model)
 ...
 * header in the Crossminer model.
 */
public real getImportPackageHeaderFreq(CrossminerModel model) 
 ...
 * Type: Direct 
 * Description: Returns the number of projects with the Require-Bundle 
 * and Import-Package headers in the Crossminer model.
 */
public real getReqBundImpPackHeadersFreq(CrossminerModel model)
 ...
 */
public rel[int,int,set[loc]] getRequireBundleDistribution(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH){
 ...
 * slot. If csv is set to true the function generates a CSV file with the distribution. 
 */
public rel[int,int,set[loc]] getImportPackageDistribution(CrossminerModel model, bool csv = true, loc pathCSV = RESULTS_PATH){
...
public rel[int,int] getRatioVersionedImportedPackagesCategorical(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	rel[int category, tuple[loc,loc,map[str,str]] dependency] relation = {
...
public rel[int,int] getRatioVersionedEportedPackagesCategorical(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	rel[int category, tuple[loc,loc,map[str,str]] dependency] relation = {
...
public rel[int,int] getRatioRangeVersionedRequiredBundlesCategorical(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	rel[int category, tuple[loc,loc,map[str,str]] dependency] relation = {
...
public rel[int,int] getRatioRangeVersionedImportedPackagesCategorical(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	rel[int category, tuple[loc,loc,map[str,str]] dependency] relation = {
...
public real getRatioImportedExpPkgs(CrossminerModel model) {
...
public real getRatioVersionedImportedExpPkgs(CrossminerModel model) {
...
public rel[int,int,rel[loc,set[loc]]] getImportersExpPkgs(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	invImportedPackages = invert(model.importedPackages);
...
public rel[int,int,rel[loc,str,set[loc]]] getVersionedImportersExpPkgs(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	versExportedPackages = {<p, m["version"]> | <b, p, m> <- model.exportedPackages};
...
public real getRatioUsedImportedPackages(CrossminerModel model) 
	= (0.0 | it + size(getUsedImportedPackagesBundle(bundle,model)) | bundle <- model.locations.logical) /
			size(model.importedPackages);

public real getRatioUsedRequiredBundlePackages(CrossminerModel model) {		
...
public real getRatioUsedTransitiveRequiredBundlePackages(CrossminerModel model) {		
	requiredPackages = getFlatPackagesTransitiveReqBundles(model);
	return (0.0 | it + size(requiredPackages[bundle] & model.importedPackagesBC[bundle]) | bundle <- model.locations.logical) /
			size(requiredPackages);
}

private set[loc] getUsedImportedPackagesBundle(loc bundle, CrossminerModel model) {
...
public rel[int,int,rel[loc,set[loc]]] getUsedImportedPackagesDistribution(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
	requiredPackages = getFlatPackagesReqBundles(model);
...
public rel[int,int,rel[loc,set[loc]]] getUsedPackagesReqBundlesDistribution(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
	requiredPackages = getFlatPackagesReqBundles(model);
...
public real getRatioImpPackagesSplit(CrossminerModel model) 
	= (0.0 | it + 1 | logical <- model.importedPackages, logical.params["split"] != "none") /
			size(model.importedPackages);	

public real getRatioExpPackagesSplit(CrossminerModel model) {
...
public rel[int,int,rel[loc,rel[loc,str]]] getImpPackagesSplit(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
...
public rel[int,int,rel[loc,rel[loc,str]]] getExpPackagesSplit(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
 ...
 * and the set of related bundles symbolic names in the third slot. 
 */
public rel[real,int,tuple[loc,loc]] getRatioUsedPackagesReqBundles(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
 ...
 * and the set of related bundles symbolic names in the third slot. 
 */
public rel[real,int,tuple[loc,loc]] getRatioUsedPackagesReqBundlesReexp(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
	rel[loc,loc] exportedPackages = getFlatExportedPackages(model);
 ...
 * and the set of related bundles symbolic names in the third slot. 
 */
public rel[int,int,set[loc]] getPkgExporters(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
 ...
 */
public rel[int,int,rel[loc,str,set[loc]]] getVersionedPkgExporters(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	versExportedPackages = {<p, m["version"]> | <b, p, m> <- model.exportedPackages};
...
public rel[real,int,loc] getRatioVersionedImportedPackagesDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
...
public rel[real,int,loc] getRatioVersionedExportedPackagesDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
...
public rel[real,int,loc] getRatioVersionedRequiredBundlesDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
...
public rel[real,int,loc] getRatioRangeVersionedImportedPackagesDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
	rel[real versionedRatio, int impPackages, loc bundle] relation = {
...
public rel[real,int,loc] getRatioRangeVersionedExportedPackagesDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
	rel[real versionedRatio, int expPackages, loc bundle] relation = {
...
public rel[real,int,loc] getRatioRangeVersionedRequiredBundlesDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
	rel[real versionedRatio, int reqBundles, loc bundle] relation = {
...
public rel[real,real,real,int,loc] getRatioImportedPackagesPerVersSpecDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
...
public rel[real,real,real,int,loc] getRatioExportedPackagesPerVersSpecDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
...
public rel[real,real,real,int,loc] getRatioRequiredBundlesPerVersSpecDistr(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
...
public rel[int,int,rel[loc,set[loc]]] getImportersUsedExpPkgs(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	invImportedPackages = invert(model.importedPackages);
	invImportedPackagesBC = invert(model.importedPackagesBC);
...
public rel[int,int,rel[loc,str,set[loc]]] getVersionedImportersUsedExpPkgs(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	versExportedPackages = {<p, m["version"]> | <b, p, m> <- model.exportedPackages};
...
public rel[real,int,tuple[loc,loc]] getRatioUsedImportedPackages(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {		
 ...
 */
public rel[int,int,int,tuple[loc,set[loc]]] getUsedUnimportedPackages(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
	importedPackages = getFlatImportedPackages(model);
	requiredPackages = getFlatPackagesReqBundles(model);
...
public rel[real,int,rel[loc,loc]] getRatioSplitPackagesExporters(CrossminerModel model, bool csv=true, loc pathCSV=RESULTS_PATH) {
...
private rel[loc,loc] getFlatExportedPackages(CrossminerModel model)
	= {<bundle, flatPackageLoc(pkg)> | <bundle, pkg, params> <- model.exportedPackages}; 
	
private rel[loc,loc] getFlatImportedPackages(CrossminerModel model)
 ...
 * @param loc logical location of a Crossminer Model package location
...
private rel[loc,loc] getReexpRequiredBundles(CrossminerModel model) {
 ...
 */
private set[loc] getPackageImporters(loc pkg, str version, CrossminerModel model) {
	invImportedPackages = invert(model.importedPackages);
	bundles = {};
 ...
 */
private set[loc] getUsedPackageImporters(loc pkg, str version, CrossminerModel model) {
	invImportedPackages = invert(model.importedPackages);
	invImportedPackagesBC = invert(model.importedPackagesBC);
...
private rel[loc,loc] getFlatPackagesReqBundles(CrossminerModel model) {
...
private rel[loc,loc] getFlatPackagesTransitiveReqBundles(CrossminerModel model) {
	rel[loc,loc] requiredBundles = getReexpRequiredBundles(model);
	rel[loc,loc] exportedPackages = {<bundle, pkg> | <bundle, pkg, params> <- model.exportedPackages}; 
	return {<bundle, flatPackageLoc(pkg)> | <bundle, pkg> <- (requiredBundles o exportedPackages)};
}
...
private set[loc] getVersionedImportedPackages(loc bundle, CrossminerModel model)
	= {pkg |<pkg, params> <- model.importedPackages[bundle], params["version-spec"] != "none"};
	
private set[loc] getImportedPackagesPerVersSpec(loc bundle, str versionSpec, CrossminerModel model)
	= {pkg |<pkg, params> <- model.importedPackages[bundle], params["version-spec"] == versionSpec};
	
private set[loc] getVersionedExportedPackages(loc bundle, CrossminerModel model)
	= {pkg |<pkg, params> <- model.exportedPackages[bundle], params["version-spec"] != "none"};
	
private set[loc] getExportedPackagesPerVersSpec(loc bundle, str versionSpec, CrossminerModel model)
	= {pkg |<pkg, params> <- model.exportedPackages[bundle], params["version-spec"] == versionSpec};
	
private set[loc] getVersionedRequiredBundles(loc bundle, CrossminerModel model)
	= {pkg |<pkg, params> <- model.requiredBundles[bundle], params["version-spec"] != "none"};
	
private set[loc] getRequiredBundlesPerVersSpec(loc bundle, str versionSpec, CrossminerModel model)
