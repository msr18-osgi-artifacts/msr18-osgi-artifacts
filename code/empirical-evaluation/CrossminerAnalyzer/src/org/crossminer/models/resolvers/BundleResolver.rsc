module org::crossminer::models::resolvers::BundleResolver
 ...
 */
public rel[loc,loc,map[str,str]] getRequiredBundles(loc logical, CrossminerModel model) {
 ...
 * (exclusive).
 */
private map[str,str] setRequiredBundlesParams(RequireBundle reqBundle, CrossminerModel model) {
	map[str,str] params = (
			"resolved" : "false", 
			"lower-version" : "[0.0.0", 
			"upper-version" : "(-1", 
 ...
 */
public loc suggestReqBundle(str symbolicName, str lowerVersion, str upperVersion, CrossminerModel model) {
