module org::crossminer::models::resolvers::PackageResolver
 ...
 */
public rel[loc,loc,map[str,str]] getExportPackages(loc logical, CrossminerModel model) {
 ...
 */
public rel[loc,loc,map[str,str]] getImportPackages(loc logical, CrossminerModel model) {
	rel[loc,loc,map[str,str]] importPackages = {};
	
	for(/ImportPackage impPackage := model.manifests[logical]) {
		params = setImportPackagesParams(impPackage, model);
...
private map[str,str] setImportPackagesParams(ImportPackage impPackage, CrossminerModel model) {
	map[str,str] params = (
			"resolved" : "false", 
			"lower-version" : "[0.0.0", 
			"upper-version" : "(-1", 
 ...
 */
private map[str,str] modifyImpPackageResolvedParam(str symbolicName, map[str,str] params, CrossminerModel model) {
 ...
 * included in the package location.
 */
public rel[loc,loc,map[str,str]] getDynamicImportPackages(loc logical, CrossminerModel model) {
	rel[loc,loc,map[str,str]] dynamicImportPackages = {};
	
	for(/DynamicImportDescription dynImpDescription := model.manifests[logical]) {
		params = setDynamicImportPackagesParams(dynImpDescription, model);
 ...
 */
private map[str,str] setDynamicImportPackagesParams(DynamicImportDescription dynImpDescription, CrossminerModel model) {
	map[str,str] params = (
			"resolved" : "false", 
			"lower-version" : "[0.0.0", 
			"upper-version" : "(-1", 
