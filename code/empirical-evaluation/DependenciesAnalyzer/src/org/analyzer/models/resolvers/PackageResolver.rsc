module org::analyzer::models::resolvers::PackageResolver
...
import org::analyzer::models::resolvers::BundleResolver;
...
private map[str,str] setImportPackagesParams(ImportPackage impPackage, OSGiModel model) {
	map[str,str] params = (
			"resolved" : "false", 
			"lower-version" : "[0.0.0", 
			"upper-version" : "(-1", 
 ...
 */
private map[str,str] setDynamicImportPackagesParams(DynamicImportDescription dynImpDescription, OSGiModel model) {
	map[str,str] params = (
			"resolved" : "false", 
			"lower-version" : "[0.0.0", 
			"upper-version" : "(-1", 
