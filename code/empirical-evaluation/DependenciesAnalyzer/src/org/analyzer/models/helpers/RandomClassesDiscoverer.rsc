module org::analyzer::models::helpers::RandomClassesDiscoverer
...
/*
 * Creates a RandomClasses model from a OSGiModel and a 
 * set of M3 models.
 */
public RandomClasses createRandomClasses(OSGiModel model, loc m3Path=M3_PATH) {
 ...
 */
private RandomClasses generateClassesPerBundle(loc logical, loc m3Path, OSGiModel model, RandomClasses modelRC) {
