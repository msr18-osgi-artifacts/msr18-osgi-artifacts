module org::analyzer::models::helpers::ExtensionDiscoverer
 ...
 */
public Extension getExtensionBundles(OSGiModel model) {
 ...
 * tuples.
 */
public rel[loc,loc] getExtensionReqBundles(OSGiModel c, Extension e) {
 ...
 */
public rel[loc,loc] getComplementExtensionReqBundles(OSGiModel c, Extension e) {
	flatE = e.extensions o invert(e.extensionPoints);
	flatRB = {<b,r> | <b,r,p> <- c.requiredBundles};
